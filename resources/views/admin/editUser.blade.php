@extends('admin.layouts.pages', ["title"=>"Edit User"])
        							...
        							@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" class="form-control " name="fullName" value="{{$user->fullName}}">
											</div>
											@error('fullName')
											{{$message}}
											@enderror
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" class="form-control" name="name" value="{{$user->name}}">
											</div>
											@error('name')
											{{$message}}
											@enderror
