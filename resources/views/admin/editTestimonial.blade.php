@extends('admin.layouts.pages', ["title"=>"Edit Testimonial"])
									...
									@method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/admin/images/'.$testimonial->image) }}" alt="" style="width: 300px;">
											</div>
											@error('image')
											{{ $message }}
											@enderror
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="{{ route('testimonialsList') }}"><button class="btn btn-primary" type="button">Cancel</button></a>
